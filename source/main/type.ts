...
export interface ResourceConfig {
  Icon: {
    Common: {
      ...
      image_char: ImageSourcePropType
      image_check_badge: ImageSourcePropType
      image_map: ImageSourcePropType
      image_card: ImageSourcePropType
      image_warning: ImageSourcePropType
      image_location: ImageSourcePropType
      image_pencil_gray: ImageSourcePropType
      image_pencil_white: ImageSourcePropType
      image_flag: ImageSourcePropType
      image_arrow_down: ImageSourcePropType
      image_user_black: ImageSourcePropType
      image_calendar_black: ImageSourcePropType
      image_reload: ImageSourcePropType
      image_logout: ImageSourcePropType
    }
    Login: {
